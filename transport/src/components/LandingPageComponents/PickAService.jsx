...
const PickAService = () => {
  ...
  return (
    <div className="w-full flex flex-col items-center pt-29 ">
      <div className="fixed top-0 left-0 right-0 z-50">
        <Header />
      </div>
      <div className="text-center flex flex-col ">
        <h2 className="text-xl">Select Your Service</h2>
        <span>Choose the transfer type that suits your journey</span>
      </div>
      <div className=" flex flex-col items-center h-[70vh] mt-8 gap-4 md:gap-8 md:w-[70%] p-4 bg-[#0f1117] rounded-lg   text-[rgba(255,255,255,0.4)] border border-[rgba(201,168,76,0.2)]">
